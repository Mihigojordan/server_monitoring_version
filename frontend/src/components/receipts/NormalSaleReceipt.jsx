...
export default function NormalSaleReceipt({ receiptSale, receiptExtra, qrUrl, onPrint }) {
  ...
  return (
    ...
    <div className="receipt-wrapper">
      <div className="receipt">
        ...
        {/* Invoice To */}
        <div style={{ marginBottom: 8, fontSize: 10.5, textAlign: 'center' }}>
        ...
        <div className="sdc-row">
          ...
          <span>{receiptSale.invoiceNo}&nbsp;&nbsp;{receiptSale.saleType}{receiptSale.receiptType}</span>
        </div>
