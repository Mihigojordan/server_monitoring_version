...
export default function TrainingSaleReceipt({ receiptSale, receiptExtra, onPrint }) {
  ...
  return (
    ...
    <div className="receipt-wrapper">
      <div className="receipt">
        ...
        {/* TRAINING MODE — top */}
        <div className="training-banner">TRAINING MODE</div>
        ...
        <div className="welcome">
          ...
          {receiptSale.customerName && (
            <div>Client Name: {receiptSale.customerName}</div>
          )}
          {receiptSale.customerTin && (
            <div>Client TIN: {receiptSale.customerTin}</div>
          )}
          {receiptSale.customerMobileNo && (
            <div>Client Phone: {receiptSale.customerMobileNo}</div>
          )}
        </div>
        ...
        {/* Bottom receipt section — no Internal Data or Signature per VSDC spec */}
