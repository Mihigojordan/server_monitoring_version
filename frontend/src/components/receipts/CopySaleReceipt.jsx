...
// Layout follows CIS spec §15.1 (page 8) — example receipt type COPY, transaction type REFUND (CR).
// isRefundCopy === true reproduces that example exactly (REFUND sub-title + reference + warning).
// A plain copy of a normal sale (CS) uses the same COPY framing without the refund-specific block.
export default function CopySaleReceipt({ receiptSale, receiptExtra, qrUrl, onPrint }) {
  ...
  const isRefundCopy = receiptSale.receiptType === 'R'
  ...
  return (
    <>
      ...
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      /* §11 — COPY/TRAINING/PROFORMA designation must be at least twice the size of the amount text */
      .copy-banner {
        text-align: center;
        font-size: 20px;
        font-weight: 700;
    ...
    <div className="receipt-wrapper">
      <div className="receipt">
        ...
        {/* CIS spec §11/§15.1 — COPY designation below header, above item description */}
        ...
        {/* §11 — "THIS IS NOT AN OFFICIAL RECEIPT" appears on every COPY */}
        ...
        {/* Thank you — matches §15.1 example closing line */}
