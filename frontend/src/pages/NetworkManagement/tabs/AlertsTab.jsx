...
export default function AlertsTab({ deviceId }) {
  const { rows, loading, error, setError, add, update, remove } = useSubcollection('networkDevices', deviceId, 'issues', 'createdAt')
            ...
            <form onSubmit={handleSubmit}>
              <div className="modal__body" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                <div className="form-group" style={{ gridColumn: '1/-1' }}>
                  ...
                  <input className="form-input" value={form.title} onChange={e => setForm(f => ({ ...f, title: e.target.value }))} placeholder="e.g. Port flapping on 12" />
                </div>
